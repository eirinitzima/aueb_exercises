...
num_stumps = 800  # Number of weak classifiers
...
# Train AdaBoost using Scikit-learn
classifier = AdaBoostClassifier(estimator=DecisionTreeClassifier(max_depth=1), n_estimators=num_stumps)
metrics_writer = MetricsCSVWriter()
training_metrics_csv = "training_metrics_adaboost_sklearn.csv"
evaluation_metrics_csv = "evaluation_metrics_adaboost_sklearn.csv"
...
visualizer.plot_learning_curves("learning_curves_adaboost_sklearn")
visualizer.generate_evaluation_table("evaluation_metrics_adaboost_sklearn.png")
