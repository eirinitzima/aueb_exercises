...
training_metrics_csv = "training_metrics_rf_sklearn.csv"
evaluation_metrics_csv = "evaluation_metrics_rf_sklearn.csv"
...
visualizer.plot_learning_curves("learning_curves_rf_sklearn")
visualizer.generate_evaluation_table("evaluation_metrics_rf_sklearn.png")
